...
public final class AnimalViewInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.AnimalViewInfoOuterClass.AnimalViewInfo result) {
        if (fHBALCDOGFIBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AnimalViewInfoOuterClass.AnimalViewInfo result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 98: {
                emu.grasscutter.net.proto.GNAAAEGCDOBOuterClass.GNAAAEGCDOB m =
                    input.readMessage(
                        emu.grasscutter.net.proto.GNAAAEGCDOBOuterClass.GNAAAEGCDOB.parser(),
                        extensionRegistry);
                if (fHBALCDOGFIBuilder_ == null) {
                  ensureFHBALCDOGFIIsMutable();
                  fHBALCDOGFI_.add(m);
