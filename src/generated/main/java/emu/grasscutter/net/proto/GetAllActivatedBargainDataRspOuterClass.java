...
public final class GetAllActivatedBargainDataRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.GetAllActivatedBargainDataRspOuterClass.GetAllActivatedBargainDataRsp result) {
        if (snapshotListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GetAllActivatedBargainDataRspOuterClass.GetAllActivatedBargainDataRsp result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.grasscutter.net.proto.BargainSnapshotOuterClass.BargainSnapshot m =
                    input.readMessage(
                        emu.grasscutter.net.proto.BargainSnapshotOuterClass.BargainSnapshot.parser(),
                        extensionRegistry);
                if (snapshotListBuilder_ == null) {
                  ensureSnapshotListIsMutable();
                  snapshotList_.add(m);
