...
emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.EvtAiSyncCombatThreatInfoNotifyOuterClass.EvtAiSyncCombatThreatInfoNotify result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.combatThreatInfoMap_ = internalGetCombatThreatInfoMap().build(CombatThreatInfoMapDefaultEntryHolder.defaultEntry);
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 122: {
                ...
                internalGetMutableCombatThreatInfoMap().ensureBuilderMap().put(
      ...
      private static final class CombatThreatInfoMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo> {
        @java.lang.Override
        public emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo build(emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo) { return (emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo) val; }
          return ((emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo> defaultEntry() {
          return CombatThreatInfoMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final CombatThreatInfoMapConverter combatThreatInfoMapConverter = new CombatThreatInfoMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder> combatThreatInfoMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder>
          internalGetCombatThreatInfoMap() {
        if (combatThreatInfoMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(combatThreatInfoMapConverter);
        }
        return combatThreatInfoMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder>
        ...
        if (combatThreatInfoMap_ == null) {
          combatThreatInfoMap_ = new com.google.protobuf.MapFieldBuilder<>(combatThreatInfoMapConverter);
        }
        bitField0_ |= 0x00000001;
        onChanged();
        return combatThreatInfoMap_;
      ...
      public int getCombatThreatInfoMapCount() {
        return internalGetCombatThreatInfoMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .AiThreatInfo&gt; combat_threat_info_map = 15;</code>
       */
      ...
      public boolean containsCombatThreatInfoMap(
        ...
        return internalGetCombatThreatInfoMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getCombatThreatInfoMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo> getCombatThreatInfoMapMap() {
        return internalGetCombatThreatInfoMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .AiThreatInfo&gt; combat_threat_info_map = 15;</code>
       */
...
emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder> map = internalGetMutableCombatThreatInfoMap().ensureBuilderMap();
        return map.containsKey(key) ? combatThreatInfoMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .AiThreatInfo&gt; combat_threat_info_map = 15;</code>
       */
      ...
      public emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo getCombatThreatInfoMapOrThrow(
        ...
        return combatThreatInfoMapConverter.build(map.get(key));
      }
      ...
      public Builder removeCombatThreatInfoMap(
        ...
        internalGetMutableCombatThreatInfoMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo>
        ...
        bitField0_ |= 0x00000001;
        return internalGetMutableCombatThreatInfoMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .AiThreatInfo&gt; combat_threat_info_map = 15;</code>
       */
      ...
      public Builder putAllCombatThreatInfoMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .AiThreatInfo&gt; combat_threat_info_map = 15;</code>
       */
      public emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder putCombatThreatInfoMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder> builderMap = internalGetMutableCombatThreatInfoMap().ensureBuilderMap();
        emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfoOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo) {
          entry = ((emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.AiThreatInfoOuterClass.AiThreatInfo.Builder) entry;
      }
      @java.lang.Override
