...
public final class FurnitureMakeSlotOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot result) {
        if (furnitureMakeDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FurnitureMakeSlotOuterClass.FurnitureMakeSlot result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 58: {
                emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData.parser(),
                        extensionRegistry);
                if (furnitureMakeDataListBuilder_ == null) {
                  ensureFurnitureMakeDataListIsMutable();
