...
public final class GcgPvePuzzleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GcgPvePuzzleInfoOuterClass.GcgPvePuzzleInfo result) {
      ...
      private void ensureCPJEMFGLLKEIsMutable() {
        if (!cPJEMFGLLKE_.isModifiable()) {
          cPJEMFGLLKE_ = makeMutableCopy(cPJEMFGLLKE_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
