...
public final class HomeModuleComfortInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result) {
      ...
      private void ensureWorldSceneBlockComfortValueListIsMutable() {
        if (!worldSceneBlockComfortValueList_.isModifiable()) {
          worldSceneBlockComfortValueList_ = makeMutableCopy(worldSceneBlockComfortValueList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
