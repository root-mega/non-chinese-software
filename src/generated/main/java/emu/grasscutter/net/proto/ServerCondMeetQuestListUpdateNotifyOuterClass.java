  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void ensureDelQuestIdListIsMutable() {
        if (!delQuestIdList_.isModifiable()) {
          delQuestIdList_ = makeMutableCopy(delQuestIdList_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensureAddQuestIdListIsMutable() {
        if (!addQuestIdList_.isModifiable()) {
          addQuestIdList_ = makeMutableCopy(addQuestIdList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
