...
public final class FontaineGatherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.FontaineGatherInfoOuterClass.FontaineGatherInfo result) {
        if (stageInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FontaineGatherInfoOuterClass.FontaineGatherInfo result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.JFGKMCDLKCNOuterClass.JFGKMCDLKCN m =
                    input.readMessage(
                        emu.grasscutter.net.proto.JFGKMCDLKCNOuterClass.JFGKMCDLKCN.parser(),
                        extensionRegistry);
                if (stageInfoListBuilder_ == null) {
                  ensureStageInfoListIsMutable();
