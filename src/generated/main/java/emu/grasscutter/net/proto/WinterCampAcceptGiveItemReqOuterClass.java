...
public final class WinterCampAcceptGiveItemReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq other = (emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq) obj;
    ...
    public static emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq parseFrom(
    ...
    public static emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.internal_static_WinterCampAcceptGiveItemReq_descriptor;
      }
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq build() {
        emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq result = buildPartial();
      ...
      private void buildPartial0(emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq result) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq) {
          return mergeFrom((emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq other) {
        if (other == emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    public static emu.grasscutter.net.proto.WinterCampAcceptGiveItemReqOuterClass.WinterCampAcceptGiveItemReq getDefaultInstance() {
