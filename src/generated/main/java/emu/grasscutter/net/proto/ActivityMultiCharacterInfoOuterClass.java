...
public final class ActivityMultiCharacterInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ActivityMultiCharacterInfoOuterClass.ActivityMultiCharacterInfo result) {
        if (stageInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ActivityMultiCharacterInfoOuterClass.ActivityMultiCharacterInfo result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.DJKIJHJIJPEOuterClass.DJKIJHJIJPE m =
                    input.readMessage(
                        emu.grasscutter.net.proto.DJKIJHJIJPEOuterClass.DJKIJHJIJPE.parser(),
                        extensionRegistry);
                if (stageInfoListBuilder_ == null) {
                  ensureStageInfoListIsMutable();
