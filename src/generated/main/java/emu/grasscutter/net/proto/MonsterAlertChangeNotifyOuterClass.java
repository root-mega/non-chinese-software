...
public final class MonsterAlertChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.MonsterAlertChangeNotifyOuterClass.MonsterAlertChangeNotify result) {
      ...
      private void ensureMonsterEntityListIsMutable() {
        if (!monsterEntityList_.isModifiable()) {
          monsterEntityList_ = makeMutableCopy(monsterEntityList_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
