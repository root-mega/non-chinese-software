...
public final class ChannellerSlabLoopDungeonStageInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ChannellerSlabLoopDungeonStageInfoOuterClass.ChannellerSlabLoopDungeonStageInfo result) {
        if (dungeonInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ChannellerSlabLoopDungeonStageInfoOuterClass.ChannellerSlabLoopDungeonStageInfo result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 114: {
                emu.grasscutter.net.proto.ChannellerSlabLoopDungeonInfoOuterClass.ChannellerSlabLoopDungeonInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ChannellerSlabLoopDungeonInfoOuterClass.ChannellerSlabLoopDungeonInfo.parser(),
                        extensionRegistry);
                if (dungeonInfoListBuilder_ == null) {
                  ensureDungeonInfoListIsMutable();
