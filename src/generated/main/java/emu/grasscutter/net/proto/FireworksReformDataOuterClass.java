...
public final class FireworksReformDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.FireworksReformDataOuterClass.FireworksReformData result) {
        if (reformParamListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FireworksReformDataOuterClass.FireworksReformData result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.proto.FireworksReformParamOuterClass.FireworksReformParam m =
                    input.readMessage(
                        emu.grasscutter.net.proto.FireworksReformParamOuterClass.FireworksReformParam.parser(),
                        extensionRegistry);
                if (reformParamListBuilder_ == null) {
                  ensureReformParamListIsMutable();
