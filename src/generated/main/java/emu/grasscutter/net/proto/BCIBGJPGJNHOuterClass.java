...
public final class BCIBGJPGJNHOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.BCIBGJPGJNHOuterClass.BCIBGJPGJNH result) {
        if (levelInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.BCIBGJPGJNHOuterClass.BCIBGJPGJNH result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 42: {
                emu.grasscutter.net.proto.BBMCNBCAMAKOuterClass.BBMCNBCAMAK m =
                    input.readMessage(
                        emu.grasscutter.net.proto.BBMCNBCAMAKOuterClass.BBMCNBCAMAK.parser(),
                        extensionRegistry);
                if (levelInfoListBuilder_ == null) {
                  ensureLevelInfoListIsMutable();
