    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.SumoActivityDetailInfoOuterClass.SumoActivityDetailInfo result) {
        ...
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.sumoStageMap_ = internalGetSumoStageMap().build(SumoStageMapDefaultEntryHolder.defaultEntry);
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                ...
                internalGetMutableSumoStageMap().ensureBuilderMap().put(
      ...
      private static final class SumoStageMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData> {
        @java.lang.Override
        public emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData build(emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData) { return (emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData) val; }
          return ((emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData> defaultEntry() {
          return SumoStageMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final SumoStageMapConverter sumoStageMapConverter = new SumoStageMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder> sumoStageMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder>
          internalGetSumoStageMap() {
        if (sumoStageMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(sumoStageMapConverter);
        }
        return sumoStageMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder>
        ...
        if (sumoStageMap_ == null) {
          sumoStageMap_ = new com.google.protobuf.MapFieldBuilder<>(sumoStageMapConverter);
        }
        bitField0_ |= 0x00000001;
        onChanged();
        return sumoStageMap_;
      ...
      public int getSumoStageMapCount() {
        return internalGetSumoStageMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .SumoStageData&gt; sumo_stage_map = 2;</code>
       */
      ...
      public boolean containsSumoStageMap(
        ...
        return internalGetSumoStageMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getSumoStageMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData> getSumoStageMapMap() {
        return internalGetSumoStageMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .SumoStageData&gt; sumo_stage_map = 2;</code>
       */
...
emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder> map = internalGetMutableSumoStageMap().ensureBuilderMap();
        return map.containsKey(key) ? sumoStageMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .SumoStageData&gt; sumo_stage_map = 2;</code>
       */
      ...
      public emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData getSumoStageMapOrThrow(
        ...
        return sumoStageMapConverter.build(map.get(key));
      }
      ...
      public Builder removeSumoStageMap(
        ...
        internalGetMutableSumoStageMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData>
        ...
        bitField0_ |= 0x00000001;
        return internalGetMutableSumoStageMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .SumoStageData&gt; sumo_stage_map = 2;</code>
       */
      ...
      public Builder putAllSumoStageMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .SumoStageData&gt; sumo_stage_map = 2;</code>
       */
      public emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder putSumoStageMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder> builderMap = internalGetMutableSumoStageMap().ensureBuilderMap();
        emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageDataOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData) {
          entry = ((emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.SumoStageDataOuterClass.SumoStageData.Builder) entry;
      }
