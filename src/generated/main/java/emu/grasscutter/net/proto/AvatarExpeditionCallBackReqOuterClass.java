...
public final class AvatarExpeditionCallBackReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AvatarExpeditionCallBackReqOuterClass.AvatarExpeditionCallBackReq result) {
      ...
      private void ensureAvatarGuidIsMutable() {
        if (!avatarGuid_.isModifiable()) {
          avatarGuid_ = makeMutableCopy(avatarGuid_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
