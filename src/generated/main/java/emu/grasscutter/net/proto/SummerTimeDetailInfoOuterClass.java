    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.SummerTimeDetailInfoOuterClass.SummerTimeDetailInfo result) {
        ...
        if (((from_bitField0_ & 0x00000004) != 0)) {
          result.stageMap_ = internalGetStageMap().build(StageMapDefaultEntryHolder.defaultEntry);
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 106: {
                ...
                internalGetMutableStageMap().ensureBuilderMap().put(
      ...
      private static final class StageMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo> {
        @java.lang.Override
        public emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo build(emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo) { return (emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo) val; }
          return ((emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo> defaultEntry() {
          return StageMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final StageMapConverter stageMapConverter = new StageMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder> stageMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder>
          internalGetStageMap() {
        if (stageMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(stageMapConverter);
        }
        return stageMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder>
        ...
        if (stageMap_ == null) {
          stageMap_ = new com.google.protobuf.MapFieldBuilder<>(stageMapConverter);
        }
        bitField0_ |= 0x00000004;
        onChanged();
        return stageMap_;
      ...
      public int getStageMapCount() {
        return internalGetStageMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .SummerTimeStageInfo&gt; stage_map = 13;</code>
       */
      ...
      public boolean containsStageMap(
        ...
        return internalGetStageMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getStageMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo> getStageMapMap() {
        return internalGetStageMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .SummerTimeStageInfo&gt; stage_map = 13;</code>
       */
...
emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder> map = internalGetMutableStageMap().ensureBuilderMap();
        return map.containsKey(key) ? stageMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .SummerTimeStageInfo&gt; stage_map = 13;</code>
       */
      ...
      public emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo getStageMapOrThrow(
        ...
        return stageMapConverter.build(map.get(key));
      }
      ...
      public Builder removeStageMap(
        ...
        internalGetMutableStageMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo>
          getMutableStageMap() {
        bitField0_ |= 0x00000004;
        return internalGetMutableStageMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .SummerTimeStageInfo&gt; stage_map = 13;</code>
       */
      ...
      public Builder putAllStageMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .SummerTimeStageInfo&gt; stage_map = 13;</code>
       */
      public emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder putStageMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder> builderMap = internalGetMutableStageMap().ensureBuilderMap();
        emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfoOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo) {
          entry = ((emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.SummerTimeStageInfoOuterClass.SummerTimeStageInfo.Builder) entry;
      }
