...
emu.grasscutter.net.proto.ParamListOuterClass.ParamList defaultValue);
    ...
    emu.grasscutter.net.proto.DungeonSettleNotifyOuterClass.DungeonSettleNotify.DetailCase getDetailCase();
  }
  /**
   * <pre>
   * CmdId: 22323
...
emu.grasscutter.net.proto.ParamListOuterClass.ParamList defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.DungeonSettleNotifyOuterClass.DungeonSettleNotify result) {
        if (exhibitionInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.DungeonSettleNotifyOuterClass.DungeonSettleNotify result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.isSuccess_ = isSuccess_;
        }
        if (((from_bitField0_ & 0x00000004) != 0)) {
          result.strengthenPointDataMap_ = internalGetStrengthenPointDataMap().build(StrengthenPointDataMapDefaultEntryHolder.defaultEntry);
        }
        if (((from_bitField0_ & 0x00000008) != 0)) {
          result.settleShow_ = internalGetSettleShow().build(SettleShowDefaultEntryHolder.defaultEntry);
        }
      ...
      private void buildPartialOneofs(emu.grasscutter.net.proto.DungeonSettleNotifyOuterClass.DungeonSettleNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                ...
                internalGetMutableStrengthenPointDataMap().ensureBuilderMap().put(
              ...
              case 82: {
                emu.grasscutter.net.proto.DungeonSettleExhibitionInfoOuterClass.DungeonSettleExhibitionInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.DungeonSettleExhibitionInfoOuterClass.DungeonSettleExhibitionInfo.parser(),
                        extensionRegistry);
                if (exhibitionInfoListBuilder_ == null) {
                  ensureExhibitionInfoListIsMutable();
              ...
              case 106: {
                ...
                internalGetMutableSettleShow().ensureBuilderMap().put(
      ...
      private static final class StrengthenPointDataMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData> {
        @java.lang.Override
        public emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData build(emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData) { return (emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData) val; }
          return ((emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData> defaultEntry() {
          return StrengthenPointDataMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final StrengthenPointDataMapConverter strengthenPointDataMapConverter = new StrengthenPointDataMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder> strengthenPointDataMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder>
          internalGetStrengthenPointDataMap() {
        if (strengthenPointDataMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(strengthenPointDataMapConverter);
        }
        return strengthenPointDataMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder>
        ...
        if (strengthenPointDataMap_ == null) {
          strengthenPointDataMap_ = new com.google.protobuf.MapFieldBuilder<>(strengthenPointDataMapConverter);
        }
        bitField0_ |= 0x00000004;
        onChanged();
        return strengthenPointDataMap_;
      ...
      public int getStrengthenPointDataMapCount() {
        return internalGetStrengthenPointDataMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .StrengthenPointData&gt; strengthen_point_data_map = 2;</code>
       */
      ...
      public boolean containsStrengthenPointDataMap(
        ...
        return internalGetStrengthenPointDataMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getStrengthenPointDataMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData> getStrengthenPointDataMapMap() {
        return internalGetStrengthenPointDataMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .StrengthenPointData&gt; strengthen_point_data_map = 2;</code>
       */
...
emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder> map = internalGetMutableStrengthenPointDataMap().ensureBuilderMap();
        return map.containsKey(key) ? strengthenPointDataMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .StrengthenPointData&gt; strengthen_point_data_map = 2;</code>
       */
      ...
      public emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData getStrengthenPointDataMapOrThrow(
        ...
        return strengthenPointDataMapConverter.build(map.get(key));
      }
      ...
      public Builder removeStrengthenPointDataMap(
        ...
        internalGetMutableStrengthenPointDataMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData>
        ...
        bitField0_ |= 0x00000004;
        return internalGetMutableStrengthenPointDataMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .StrengthenPointData&gt; strengthen_point_data_map = 2;</code>
       */
      ...
      public Builder putAllStrengthenPointDataMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .StrengthenPointData&gt; strengthen_point_data_map = 2;</code>
       */
      public emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder putStrengthenPointDataMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder> builderMap = internalGetMutableStrengthenPointDataMap().ensureBuilderMap();
        emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointDataOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData) {
          entry = ((emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.StrengthenPointDataOuterClass.StrengthenPointData.Builder) entry;
      }

      private static final class SettleShowConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder, emu.grasscutter.net.proto.ParamListOuterClass.ParamList> {
        @java.lang.Override
        public emu.grasscutter.net.proto.ParamListOuterClass.ParamList build(emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.ParamListOuterClass.ParamList) { return (emu.grasscutter.net.proto.ParamListOuterClass.ParamList) val; }
          return ((emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamList> defaultEntry() {
          return SettleShowDefaultEntryHolder.defaultEntry;
        }
      };
      private static final SettleShowConverter settleShowConverter = new SettleShowConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder, emu.grasscutter.net.proto.ParamListOuterClass.ParamList, emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder> settleShow_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder, emu.grasscutter.net.proto.ParamListOuterClass.ParamList, emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder>
          internalGetSettleShow() {
        if (settleShow_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(settleShowConverter);
        }
        return settleShow_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder, emu.grasscutter.net.proto.ParamListOuterClass.ParamList, emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder>
        ...
        if (settleShow_ == null) {
          settleShow_ = new com.google.protobuf.MapFieldBuilder<>(settleShowConverter);
        }
        bitField0_ |= 0x00000008;
        onChanged();
        return settleShow_;
      ...
      public int getSettleShowCount() {
        return internalGetSettleShow().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .ParamList&gt; settle_show = 13;</code>
       */
      ...
      public boolean containsSettleShow(
        ...
        return internalGetSettleShow().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getSettleShowMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamList> getSettleShowMap() {
        return internalGetSettleShow().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .ParamList&gt; settle_show = 13;</code>
       */
...
emu.grasscutter.net.proto.ParamListOuterClass.ParamList defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder> map = internalGetMutableSettleShow().ensureBuilderMap();
        return map.containsKey(key) ? settleShowConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .ParamList&gt; settle_show = 13;</code>
       */
      ...
      public emu.grasscutter.net.proto.ParamListOuterClass.ParamList getSettleShowOrThrow(
        ...
        return settleShowConverter.build(map.get(key));
      }
      ...
      public Builder removeSettleShow(
        ...
        internalGetMutableSettleShow().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamList>
        ...
        bitField0_ |= 0x00000008;
        return internalGetMutableSettleShow().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .ParamList&gt; settle_show = 13;</code>
       */
      ...
      public Builder putAllSettleShow(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamList> e : values.entrySet()) {
          if (e.getKey() == null || e.getValue() == null) {
            throw new NullPointerException();
          }
        }
       ...
       * <code>map&lt;uint32, .ParamList&gt; settle_show = 13;</code>
       */
      public emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder putSettleShowBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder> builderMap = internalGetMutableSettleShow().ensureBuilderMap();
        emu.grasscutter.net.proto.ParamListOuterClass.ParamListOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.ParamListOuterClass.ParamList.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.ParamListOuterClass.ParamList) {
          entry = ((emu.grasscutter.net.proto.ParamListOuterClass.ParamList) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.ParamListOuterClass.ParamList.Builder) entry;
      }
