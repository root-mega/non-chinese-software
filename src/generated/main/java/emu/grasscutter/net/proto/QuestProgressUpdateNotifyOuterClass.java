...
public final class QuestProgressUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result) {
      ...
      private void ensureFinishProgressListIsMutable() {
        if (!finishProgressList_.isModifiable()) {
          finishProgressList_ = makeMutableCopy(finishProgressList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
      ...
      private void ensureFailProgressListIsMutable() {
        if (!failProgressList_.isModifiable()) {
          failProgressList_ = makeMutableCopy(failProgressList_);
        }
        bitField0_ |= 0x00000004;
      }
      /**
