...
emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FleurFairMusicGameInfoOuterClass.FleurFairMusicGameInfo result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.musicRecordMap_ = internalGetMusicRecordMap().build(MusicRecordMapDefaultEntryHolder.defaultEntry);
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 90: {
                ...
                internalGetMutableMusicRecordMap().ensureBuilderMap().put(
      ...
      private static final class MusicRecordMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord> {
        @java.lang.Override
        public emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord build(emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord) { return (emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord) val; }
          return ((emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord> defaultEntry() {
          return MusicRecordMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final MusicRecordMapConverter musicRecordMapConverter = new MusicRecordMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder> musicRecordMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder>
          internalGetMusicRecordMap() {
        if (musicRecordMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(musicRecordMapConverter);
        }
        return musicRecordMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder>
        ...
        if (musicRecordMap_ == null) {
          musicRecordMap_ = new com.google.protobuf.MapFieldBuilder<>(musicRecordMapConverter);
        }
        bitField0_ |= 0x00000001;
        onChanged();
        return musicRecordMap_;
      ...
      public int getMusicRecordMapCount() {
        return internalGetMusicRecordMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .FleurFairMusicRecord&gt; music_record_map = 11;</code>
       */
      ...
      public boolean containsMusicRecordMap(
        ...
        return internalGetMusicRecordMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getMusicRecordMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord> getMusicRecordMapMap() {
        return internalGetMusicRecordMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .FleurFairMusicRecord&gt; music_record_map = 11;</code>
       */
...
emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder> map = internalGetMutableMusicRecordMap().ensureBuilderMap();
        return map.containsKey(key) ? musicRecordMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .FleurFairMusicRecord&gt; music_record_map = 11;</code>
       */
      ...
      public emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord getMusicRecordMapOrThrow(
        ...
        return musicRecordMapConverter.build(map.get(key));
      }
      ...
      public Builder removeMusicRecordMap(
        ...
        internalGetMutableMusicRecordMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord>
        ...
        bitField0_ |= 0x00000001;
        return internalGetMutableMusicRecordMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .FleurFairMusicRecord&gt; music_record_map = 11;</code>
       */
      ...
      public Builder putAllMusicRecordMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .FleurFairMusicRecord&gt; music_record_map = 11;</code>
       */
      public emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder putMusicRecordMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder> builderMap = internalGetMutableMusicRecordMap().ensureBuilderMap();
        emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecordOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord) {
          entry = ((emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.FleurFairMusicRecordOuterClass.FleurFairMusicRecord.Builder) entry;
      }
      @java.lang.Override
