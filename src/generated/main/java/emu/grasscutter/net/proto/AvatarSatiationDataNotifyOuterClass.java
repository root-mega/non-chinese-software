...
public final class AvatarSatiationDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.AvatarSatiationDataNotifyOuterClass.AvatarSatiationDataNotify result) {
        if (satiationDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AvatarSatiationDataNotifyOuterClass.AvatarSatiationDataNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.AvatarSatiationDataOuterClass.AvatarSatiationData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.AvatarSatiationDataOuterClass.AvatarSatiationData.parser(),
                        extensionRegistry);
                if (satiationDataListBuilder_ == null) {
                  ensureSatiationDataListIsMutable();
