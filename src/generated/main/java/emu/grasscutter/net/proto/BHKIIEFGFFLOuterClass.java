...
public final class BHKIIEFGFFLOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.BHKIIEFGFFLOuterClass.BHKIIEFGFFL result) {
        if (levelInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.BHKIIEFGFFLOuterClass.BHKIIEFGFFL result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.DIAODPEOGAAOuterClass.DIAODPEOGAA m =
                    input.readMessage(
                        emu.grasscutter.net.proto.DIAODPEOGAAOuterClass.DIAODPEOGAA.parser(),
                        extensionRegistry);
                if (levelInfoListBuilder_ == null) {
                  ensureLevelInfoListIsMutable();
