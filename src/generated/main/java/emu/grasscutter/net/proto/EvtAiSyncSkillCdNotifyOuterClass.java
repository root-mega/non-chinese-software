...
emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo defaultValue) {
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.EvtAiSyncSkillCdNotifyOuterClass.EvtAiSyncSkillCdNotify result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.aiCdMap_ = internalGetAiCdMap().build(AiCdMapDefaultEntryHolder.defaultEntry);
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 82: {
                ...
                internalGetMutableAiCdMap().ensureBuilderMap().put(
      ...
      private static final class AiCdMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo> {
        @java.lang.Override
        public emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo build(emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo) { return (emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo) val; }
          return ((emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo> defaultEntry() {
          return AiCdMapDefaultEntryHolder.defaultEntry;
        }
      };
      private static final AiCdMapConverter aiCdMapConverter = new AiCdMapConverter();

      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder> aiCdMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder>
          internalGetAiCdMap() {
        if (aiCdMap_ == null) {
          return new com.google.protobuf.MapFieldBuilder<>(aiCdMapConverter);
        }
        return aiCdMap_;
      }
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder>
        ...
        if (aiCdMap_ == null) {
          aiCdMap_ = new com.google.protobuf.MapFieldBuilder<>(aiCdMapConverter);
        }
        bitField0_ |= 0x00000001;
        onChanged();
        return aiCdMap_;
      ...
      public int getAiCdMapCount() {
        return internalGetAiCdMap().ensureBuilderMap().size();
      }
      /**
       * <code>map&lt;uint32, .AiSkillCdInfo&gt; ai_cd_map = 10;</code>
       */
      ...
      public boolean containsAiCdMap(
        ...
        return internalGetAiCdMap().ensureBuilderMap().containsKey(key);
      }
      /**
       * Use {@link #getAiCdMapMap()} instead.
       */
      ...
      @java.lang.Override
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo> getAiCdMapMap() {
        return internalGetAiCdMap().getImmutableMap();
      }
      /**
       * <code>map&lt;uint32, .AiSkillCdInfo&gt; ai_cd_map = 10;</code>
       */
...
emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder> map = internalGetMutableAiCdMap().ensureBuilderMap();
        return map.containsKey(key) ? aiCdMapConverter.build(map.get(key)) : defaultValue;
      }
      /**
       * <code>map&lt;uint32, .AiSkillCdInfo&gt; ai_cd_map = 10;</code>
       */
      ...
      public emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo getAiCdMapOrThrow(
        ...
        return aiCdMapConverter.build(map.get(key));
      }
      ...
      public Builder removeAiCdMap(
        ...
        internalGetMutableAiCdMap().ensureBuilderMap()
            .remove(key);
        return this;
      }
      /**
      ...
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo>
          getMutableAiCdMap() {
        bitField0_ |= 0x00000001;
        return internalGetMutableAiCdMap().ensureMessageMap();
      }
      /**
       * <code>map&lt;uint32, .AiSkillCdInfo&gt; ai_cd_map = 10;</code>
       */
      ...
      public Builder putAllAiCdMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .AiSkillCdInfo&gt; ai_cd_map = 10;</code>
       */
      public emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder putAiCdMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder> builderMap = internalGetMutableAiCdMap().ensureBuilderMap();
        emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfoOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo) {
          entry = ((emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.AiSkillCdInfoOuterClass.AiSkillCdInfo.Builder) entry;
      }
      @java.lang.Override
