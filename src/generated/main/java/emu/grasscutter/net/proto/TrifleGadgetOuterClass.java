...
public final class TrifleGadgetOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.TrifleGadgetOuterClass.TrifleGadget result) {
      ...
      public Builder mergeItem(emu.grasscutter.net.proto.ItemOuterClass.Item value) {
        if (itemBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            item_ != null &&
            item_ != emu.grasscutter.net.proto.ItemOuterClass.Item.getDefaultInstance()) {
