...
emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo defaultValue) {
    ...
    public static final class Builder extends
      ...
      private static final class StageMapConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo> {
        @java.lang.Override
        public emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo build(emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder val) {
          if (val instanceof emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo) { return (emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo) val; }
          return ((emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo> defaultEntry() {
      ...
      private com.google.protobuf.MapFieldBuilder<
          java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.Builder> stageMap_;
      private com.google.protobuf.MapFieldBuilder<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.Builder>
          internalGetStageMap() {
        if (stageMap_ == null) {
...
emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo defaultValue) {
        ...
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder> map = internalGetMutableStageMap().ensureBuilderMap();
      ...
      public Builder putAllStageMap(
        ...
        for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo> e : values.entrySet()) {
       ...
       * <code>map&lt;uint32, .HachiStageInfo&gt; stage_map = 8;</code>
       */
      public emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.Builder putStageMapBuilderIfAbsent(
          int key) {
        java.util.Map<java.lang.Integer, emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder> builderMap = internalGetMutableStageMap().ensureBuilderMap();
        emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfoOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo) {
          entry = ((emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (emu.grasscutter.net.proto.HachiStageInfoOuterClass.HachiStageInfo.Builder) entry;
      }
      @java.lang.Override
