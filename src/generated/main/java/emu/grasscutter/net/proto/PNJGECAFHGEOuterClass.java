...
public final class PNJGECAFHGEOuterClass {
  private PNJGECAFHGEOuterClass() {}
  ...
  public interface PNJGECAFHGEOrBuilder extends
     ...
     * <code>repeated .NDKAMJGCKKN level_info_list = 15;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKNOrBuilder> 
  ...
  public static final class PNJGECAFHGE extends
      ...
      // @@protoc_insertion_point(message_implements:PNJGECAFHGE)
      PNJGECAFHGEOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use PNJGECAFHGE.newBuilder() to construct.
    private PNJGECAFHGE(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private PNJGECAFHGE() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKNOrBuilder getLevelInfoListOrBuilder(
        int index) {
      return levelInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE other = (emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE) obj;
    ...
    public static emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE parseFrom(
    ...
    public static emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE.getDefaultInstance();
      }
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE result) {
        if (levelInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN m =
                    input.readMessage(
                        emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN.parser(),
                        extensionRegistry);
                if (levelInfoListBuilder_ == null) {
                  ensureLevelInfoListIsMutable();
      ...
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN, emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN.Builder, emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKNOrBuilder> levelInfoListBuilder_;
       ...
       * <code>repeated .NDKAMJGCKKN level_info_list = 15;</code>
       */
      public Builder addLevelInfoList(emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN value) {
        if (levelInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllLevelInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN> values) {
        if (levelInfoListBuilder_ == null) {
          ensureLevelInfoListIsMutable();
      ...
      public emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN.Builder addLevelInfoListBuilder(
          int index) {
        return getLevelInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN.getDefaultInstance());
      }
      /**
       * <code>repeated .NDKAMJGCKKN level_info_list = 15;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.NDKAMJGCKKNOuterClass.NDKAMJGCKKN.Builder> 
      ...
      // @@protoc_insertion_point(builder_scope:PNJGECAFHGE)
    }
    ...
    public static emu.grasscutter.net.proto.PNJGECAFHGEOuterClass.PNJGECAFHGE getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<PNJGECAFHGE>
        PARSER = new com.google.protobuf.AbstractParser<PNJGECAFHGE>() {
      @java.lang.Override
      public PNJGECAFHGE parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
    ...
    public static com.google.protobuf.Parser<PNJGECAFHGE> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<PNJGECAFHGE> getParserForType() {
      return PARSER;
    }
