  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void ensureBeKilledNumListIsMutable() {
        if (!beKilledNumList_.isModifiable()) {
          beKilledNumList_ = makeMutableCopy(beKilledNumList_);
        }
        bitField0_ |= 0x00000001;
      }
      /**
      ...
      private void ensureBeCapturedNumListIsMutable() {
        if (!beCapturedNumList_.isModifiable()) {
          beCapturedNumList_ = makeMutableCopy(beCapturedNumList_);
        }
        bitField0_ |= 0x00000002;
      }
      /**
